...
export function EmojiStickerIcon({
	width = 24,
	height = 24,
	color = "currentColor",
	...props
	...
	return _jsx("svg", {
		...
		height: height,
		fill: color,
		"aria-label": "Emoji Sticker Smiley",
		"aria-labelledby": "Emoji Sticker Smiley",
		"aria-hidden": true,
		...props,
		children: _jsx("path", {
...
EmojiStickerIcon.displayName = "EmojiStickerIcon";
export default EmojiStickerIcon;
//# sourceMappingURL=emoji-sticker-icon.js.map
