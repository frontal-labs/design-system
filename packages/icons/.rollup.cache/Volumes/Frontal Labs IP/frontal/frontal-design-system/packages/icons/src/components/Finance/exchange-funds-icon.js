...
export function ExchangeFundsIcon({
	width = 24,
	height = 24,
	color = "currentColor",
	...props
	...
	return _jsx("svg", {
		...
		height: height,
		fill: color,
		"aria-label": "Exchange Swap Money",
		"aria-labelledby": "Exchange Swap Money",
		"aria-hidden": true,
		...props,
		children: _jsx("path", {
...
ExchangeFundsIcon.displayName = "ExchangeFundsIcon";
export default ExchangeFundsIcon;
//# sourceMappingURL=exchange-funds-icon.js.map
