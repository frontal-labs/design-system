...
export function ForwardEndMiniIcon({
	width = 24,
	height = 24,
	color = "currentColor",
	...props
	...
	return _jsx("svg", {
		...
		height: height,
		fill: color,
		"aria-label": "Forward Arrow Right",
		"aria-labelledby": "Forward Arrow Right",
		"aria-hidden": true,
		...props,
		children: _jsx("path", {
...
ForwardEndMiniIcon.displayName = "ForwardEndMiniIcon";
export default ForwardEndMiniIcon;
//# sourceMappingURL=forward-end-mini-icon.js.map
