...
export function MentalHealthIcon({
	width = 24,
	height = 24,
	color = "currentColor",
	...props
	...
	return _jsx("svg", {
		...
		height: height,
		fill: color,
		"aria-label": "Brain Smiley Mental Health",
		"aria-labelledby": "Brain Smiley Mental Health",
		"aria-hidden": true,
		...props,
		children: _jsx("path", {
...
//# sourceMappingURL=mental-health-icon.js.map
