# Contributing to @frontal/components

Thank you for your interest in contributing to `@frontal/components`!
...
Ensure all new components have appropriate tests and examples.
