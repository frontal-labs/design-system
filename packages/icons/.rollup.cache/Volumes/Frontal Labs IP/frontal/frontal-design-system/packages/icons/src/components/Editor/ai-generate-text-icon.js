...
export function AiGenerateTextIcon({
	width = 24,
	height = 24,
	color = "currentColor",
	...props
	...
	return _jsx("svg", {
		...
		"aria-labelledby": "Ai Generate Text",
		"aria-hidden": true,
		...props,
		children: _jsx("path", {
...
AiGenerateTextIcon.displayName = "AiGenerateTextIcon";
export default AiGenerateTextIcon;
//# sourceMappingURL=ai-generate-text-icon.js.map
