...
export function SunCloudyIcon({
	...
	return _jsx("svg", {
		...
		height: height,
		fill: color,
		"aria-label": "Sun Cloud Weather",
		"aria-labelledby": "Sun Cloud Weather",
		"aria-hidden": true,
		...props,
		children: _jsx("path", {
...
SunCloudyIcon.displayName = "SunCloudyIcon";
export default SunCloudyIcon;
//# sourceMappingURL=sun-cloudy-icon.js.map
