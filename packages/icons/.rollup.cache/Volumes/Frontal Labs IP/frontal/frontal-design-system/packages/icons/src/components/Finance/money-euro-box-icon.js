...
export function MoneyEuroBoxIcon({
	width = 24,
	height = 24,
	color = "currentColor",
	...props
	...
	return _jsx("svg", {
		...
		height: height,
		fill: color,
		"aria-label": "Money Euro Box",
		"aria-labelledby": "Money Euro Box",
		"aria-hidden": true,
		...props,
		children: _jsx("path", {
...
MoneyEuroBoxIcon.displayName = "MoneyEuroBoxIcon";
export default MoneyEuroBoxIcon;
//# sourceMappingURL=money-euro-box-icon.js.map
