...
export function VolumeOffVibrateIcon({
	width = 24,
	height = 24,
	color = "currentColor",
	...props
	...
	return _jsx("svg", {
		...
		height: height,
		fill: color,
		"aria-label": "Speaker Volume Mute",
		"aria-labelledby": "Speaker Volume Mute",
		"aria-hidden": true,
		...props,
		children: _jsx("path", {
...
VolumeOffVibrateIcon.displayName = "VolumeOffVibrateIcon";
export default VolumeOffVibrateIcon;
//# sourceMappingURL=volume-off-vibrate-icon.js.map
