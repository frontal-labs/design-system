...
export function Box_1Icon({
	...
	return _jsx("svg", {
		...
		height: height,
		fill: color,
		"aria-label": "Box Package Shipping",
		"aria-labelledby": "Box Package Shipping",
		"aria-hidden": true,
		...props,
		children: _jsx("path", {
...
Box_1Icon.displayName = "Box_1Icon";
export default Box_1Icon;
//# sourceMappingURL=box-1-icon.js.map
