...
Complete API documentation for `@frontal-labs/icons`.
...
```typescript
// Individual imports
import { ArrowUpIcon, SearchIcon, CalendarIcon } from '@frontal-labs/icons';
...
**Example:**
```typescript
import { getIconMetadata } from '@frontal-labs/icons';
...
**Example:**
```typescript
import { groupIconsByCategory } from '@frontal-labs/icons';
...
**Example:**
```typescript
import { searchIcons } from '@frontal-labs/icons';
...
**Example:**
```typescript
import { getCategories } from '@frontal-labs/icons';
...
**Example:**
```typescript
import { extractIconName } from '@frontal-labs/icons';
...
**Example:**
```typescript
import { extractCategory } from '@frontal-labs/icons';
...
**Example:**
```typescript
import { normalizeSize } from '@frontal-labs/icons';
...
**Example:**
```typescript
import { normalizeColor } from '@frontal-labs/icons';
...
**Example:**
```typescript
import { getIconProps } from '@frontal-labs/icons';
