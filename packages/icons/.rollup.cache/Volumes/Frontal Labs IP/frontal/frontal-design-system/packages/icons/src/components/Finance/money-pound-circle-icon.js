...
export function MoneyPoundCircleIcon({
	width = 24,
	height = 24,
	color = "currentColor",
	...props
	...
	return _jsx("svg", {
		...
		height: height,
		fill: color,
		"aria-label": "Money Currency Pound",
		"aria-labelledby": "Money Currency Pound",
		"aria-hidden": true,
		...props,
		children: _jsx("path", {
...
MoneyPoundCircleIcon.displayName = "MoneyPoundCircleIcon";
export default MoneyPoundCircleIcon;
//# sourceMappingURL=money-pound-circle-icon.js.map
