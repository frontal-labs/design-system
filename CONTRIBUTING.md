...
This project is released under the **Non‑Distributable, Non‑Commercial, Non‑Modifiable Software License** (see the `LICENSE` file).  
...
* **Questions about the license** – Contact the maintainer (`maintainer@example.com`).  
