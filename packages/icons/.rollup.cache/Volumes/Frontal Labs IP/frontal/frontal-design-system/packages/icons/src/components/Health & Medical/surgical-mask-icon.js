...
export function SurgicalMaskIcon({
	width = 24,
	height = 24,
	color = "currentColor",
	...props
	...
	return _jsx("svg", {
		...
		height: height,
		fill: color,
		"aria-label": "Mask Surgical Mask Health",
		"aria-labelledby": "Mask Surgical Mask Health",
		"aria-hidden": true,
		...props,
		children: _jsx("path", {
...
SurgicalMaskIcon.displayName = "SurgicalMaskIcon";
export default SurgicalMaskIcon;
//# sourceMappingURL=surgical-mask-icon.js.map
