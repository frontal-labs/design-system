# @frontal-labs/blocks Documentation

## Overview

The `@frontal-labs/blocks` package provides a comprehensive collection of pre-built UI blocks and components for the Frontal design system. These blocks are ready-to-use implementations of common UI patterns including dashboards, sidebars, calendars, authentication forms, and more.
...
```bash
bun install @frontal-labs/blocks
```
...
import Dashboard01 from '@frontal-labs/blocks/components/dashboard-01/page';
import Sidebar01 from '@frontal-labs/blocks/components/sidebar-01/page';
```
...
All blocks use icons from `@frontal-labs/icons` package. The package has been migrated from `lucide-react` to use the Frontal icon library.
...
4. Use `@frontal-labs/icons` for all icons
