...
export function ShipVariantIcon({
	width = 24,
	height = 24,
	color = "currentColor",
	...props
	...
	return _jsx("svg", {
		...
		height: height,
		fill: color,
		"aria-label": "Ship Boat Sea",
		"aria-labelledby": "Ship Boat Sea",
		"aria-hidden": true,
		...props,
		children: _jsx("path", {
...
ShipVariantIcon.displayName = "ShipVariantIcon";
export default ShipVariantIcon;
//# sourceMappingURL=ship-variant-icon.js.map
