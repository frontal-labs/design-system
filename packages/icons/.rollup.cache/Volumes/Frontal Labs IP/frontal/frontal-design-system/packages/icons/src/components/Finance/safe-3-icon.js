...
export function Safe_3Icon({
	...
	return _jsx("svg", {
		...
		height: height,
		fill: color,
		"aria-label": "Safe Lock Security",
		"aria-labelledby": "Safe Lock Security",
		"aria-hidden": true,
		...props,
		children: _jsx("path", {
...
Safe_3Icon.displayName = "Safe_3Icon";
export default Safe_3Icon;
//# sourceMappingURL=safe-3-icon.js.map
