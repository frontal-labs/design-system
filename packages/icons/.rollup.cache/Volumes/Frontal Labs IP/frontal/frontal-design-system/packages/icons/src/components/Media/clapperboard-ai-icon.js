...
export function ClapperboardAiIcon({
	width = 24,
	height = 24,
	color = "currentColor",
	...props
	...
	return _jsx("svg", {
		...
		height: height,
		fill: color,
		"aria-label": "Clapperboard Film Movie",
		"aria-labelledby": "Clapperboard Film Movie",
		"aria-hidden": true,
		...props,
		children: _jsx("path", {
...
ClapperboardAiIcon.displayName = "ClapperboardAiIcon";
export default ClapperboardAiIcon;
//# sourceMappingURL=clapperboard-ai-icon.js.map
