...
export function MvAiIcon({
	...
	return _jsx("svg", {
		...
		height: height,
		fill: color,
		"aria-label": "Media Player Play",
		"aria-labelledby": "Media Player Play",
		"aria-hidden": true,
		...props,
		children: _jsx("path", {
...
MvAiIcon.displayName = "MvAiIcon";
export default MvAiIcon;
//# sourceMappingURL=mv-ai-icon.js.map
