...
export function BarChartBoxAiIcon({
	width = 24,
	height = 24,
	color = "currentColor",
	...props
	...
	return _jsx("svg", {
		...
		height: height,
		fill: color,
		"aria-label": "Bar Chart Box Ai",
		"aria-labelledby": "Bar Chart Box Ai",
		"aria-hidden": true,
		...props,
		children: _jsx("path", {
...
BarChartBoxAiIcon.displayName = "BarChartBoxAiIcon";
export default BarChartBoxAiIcon;
//# sourceMappingURL=bar-chart-box-ai-icon.js.map
