...
export function PassExpiredIcon({
	width = 24,
	height = 24,
	color = "currentColor",
	...props
	...
	return _jsx("svg", {
		...
		height: height,
		fill: color,
		"aria-label": "Pass Expired Card",
		"aria-labelledby": "Pass Expired Card",
		"aria-hidden": true,
		...props,
		children: _jsx("path", {
...
PassExpiredIcon.displayName = "PassExpiredIcon";
export default PassExpiredIcon;
//# sourceMappingURL=pass-expired-icon.js.map
