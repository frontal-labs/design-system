...
export function VipCrownVariantIcon({
	width = 24,
	height = 24,
	color = "currentColor",
	...props
	...
	return _jsx("svg", {
		...
		height: height,
		fill: color,
		"aria-label": "Crown Vip Royalty",
		"aria-labelledby": "Crown Vip Royalty",
		"aria-hidden": true,
		...props,
		children: _jsx("path", {
...
VipCrownVariantIcon.displayName = "VipCrownVariantIcon";
export default VipCrownVariantIcon;
//# sourceMappingURL=vip-crown-variant-icon.js.map
