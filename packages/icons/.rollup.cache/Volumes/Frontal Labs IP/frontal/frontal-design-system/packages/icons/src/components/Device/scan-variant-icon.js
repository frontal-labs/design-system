...
export function ScanVariantIcon({
	width = 24,
	height = 24,
	color = "currentColor",
	...props
	...
	return _jsx("svg", {
		...
		height: height,
		fill: color,
		"aria-label": "Scan Circle Document",
		"aria-labelledby": "Scan Circle Document",
		"aria-hidden": true,
		...props,
		children: _jsx("path", {
...
ScanVariantIcon.displayName = "ScanVariantIcon";
export default ScanVariantIcon;
//# sourceMappingURL=scan-variant-icon.js.map
