...
function Input({
	...
	return (
		...
		>
			<InputPrimitive
				className={cn(
					"h-8.5 w-full min-w-0 rounded-[inherit] px-[calc(var(--spacing)*3-1px)] leading-8.5 outline-none placeholder:text-muted-foreground/72 sm:h-7.5 sm:leading-7.5",
					size === "small" &&
						"h-7.5 px-[calc(var(--spacing)*2.5-1px)] leading-7.5 sm:h-6.5 sm:leading-6.5",
					size === "large" && "h-9.5 leading-9.5 sm:h-8.5 sm:leading-8.5",
					props.type === "search" &&
