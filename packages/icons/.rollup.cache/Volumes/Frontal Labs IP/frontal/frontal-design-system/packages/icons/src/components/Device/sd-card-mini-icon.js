...
export function SdCardMiniIcon({
	width = 24,
	height = 24,
	color = "currentColor",
	...props
	...
	return _jsx("svg", {
		...
		height: height,
		fill: color,
		"aria-label": "Sd Card Storage Memory",
		"aria-labelledby": "Sd Card Storage Memory",
		"aria-hidden": true,
		...props,
		children: _jsx("path", {
...
SdCardMiniIcon.displayName = "SdCardMiniIcon";
export default SdCardMiniIcon;
//# sourceMappingURL=sd-card-mini-icon.js.map
