...
export function CriminalIcon({
	...
	return _jsx("svg", {
		...
		height: height,
		fill: color,
		"aria-label": "Criminal Mask Face",
		"aria-labelledby": "Criminal Mask Face",
		"aria-hidden": true,
		...props,
		children: _jsx("path", {
...
CriminalIcon.displayName = "CriminalIcon";
export default CriminalIcon;
//# sourceMappingURL=criminal-icon.js.map
