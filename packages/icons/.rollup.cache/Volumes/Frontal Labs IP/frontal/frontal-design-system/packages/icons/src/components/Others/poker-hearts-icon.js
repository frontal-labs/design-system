...
export function PokerHeartsIcon({
	width = 24,
	height = 24,
	color = "currentColor",
	...props
	...
	return _jsx("svg", {
		...
		height: height,
		fill: color,
		"aria-label": "Poker Card Hearts",
		"aria-labelledby": "Poker Card Hearts",
		"aria-hidden": true,
		...props,
		children: _jsx("path", {
...
PokerHeartsIcon.displayName = "PokerHeartsIcon";
export default PokerHeartsIcon;
//# sourceMappingURL=poker-hearts-icon.js.map
