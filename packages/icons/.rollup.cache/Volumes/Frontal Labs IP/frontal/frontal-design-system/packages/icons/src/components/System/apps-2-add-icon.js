...
export function Apps_2AddIcon({
	...
	return _jsx("svg", {
		...
		height: height,
		fill: color,
		"aria-label": "Apps Grid Add",
		"aria-labelledby": "Apps Grid Add",
		"aria-hidden": true,
		...props,
		children: _jsx("path", {
...
Apps_2AddIcon.displayName = "Apps_2AddIcon";
export default Apps_2AddIcon;
//# sourceMappingURL=apps-2-add-icon.js.map
