...
export function GitPrDraftIcon({
	width = 24,
	height = 24,
	color = "currentColor",
	...props
	...
	return _jsx("svg", {
		...
		height: height,
		fill: color,
		"aria-label": "Git Pull Request Draft",
		"aria-labelledby": "Git Pull Request Draft",
		"aria-hidden": true,
		...props,
		children: _jsx("path", {
...
GitPrDraftIcon.displayName = "GitPrDraftIcon";
export default GitPrDraftIcon;
//# sourceMappingURL=git-pr-draft-icon.js.map
