...
Comprehensive guide for using `@frontal/icons` in your applications.
...
```tsx
import { ArrowUpIcon, SearchIcon } from '@frontal/icons';
...
```tsx
import { SidebarMenuButton } from '@frontal/ui';
import { HomeIcon, SettingsIcon, UserIcon } from '@frontal/icons';
...
```tsx
import { Input } from '@frontal/ui';
import { SearchIcon, MailIcon } from '@frontal/icons';
...
```tsx
import { Card, CardHeader, CardTitle, CardContent } from '@frontal/ui';
import { CheckIcon, AlertIcon } from '@frontal/icons';
...
```tsx
import { searchIcons, getIconMetadata } from '@frontal/icons';
...
```tsx
import { groupIconsByCategory, getIconMetadata } from '@frontal/icons';
...
import { searchIcons, getCategories, getIconMetadata } from '@frontal/icons';
import * as Icons from '@frontal/icons';
...
```tsx
import { NotificationIcon } from '@frontal/icons';
...
```tsx
import { EditIcon } from '@frontal/icons';
...
1. Find equivalent icon in `@frontal/icons`
...
- Check import path: `import { IconName } from '@frontal/icons'`
...
- Import types: `import type { IconProps } from '@frontal/icons'`
