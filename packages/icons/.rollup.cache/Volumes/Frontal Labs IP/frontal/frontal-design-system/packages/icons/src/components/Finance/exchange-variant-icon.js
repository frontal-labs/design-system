...
export function ExchangeVariantIcon({
	width = 24,
	height = 24,
	color = "currentColor",
	...props
	...
	return _jsx("svg", {
		...
		height: height,
		fill: color,
		"aria-label": "Exchange Swap Currency",
		"aria-labelledby": "Exchange Swap Currency",
		"aria-hidden": true,
		...props,
		children: _jsx("path", {
...
ExchangeVariantIcon.displayName = "ExchangeVariantIcon";
export default ExchangeVariantIcon;
//# sourceMappingURL=exchange-variant-icon.js.map
