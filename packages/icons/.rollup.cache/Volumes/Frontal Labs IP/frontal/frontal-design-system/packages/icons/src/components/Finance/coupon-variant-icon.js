...
export function CouponVariantIcon({
	width = 24,
	height = 24,
	color = "currentColor",
	...props
	...
	return _jsx("svg", {
		...
		height: height,
		fill: color,
		"aria-label": "Coupon Discount Voucher",
		"aria-labelledby": "Coupon Discount Voucher",
		"aria-hidden": true,
		...props,
		children: _jsx("path", {
...
CouponVariantIcon.displayName = "CouponVariantIcon";
export default CouponVariantIcon;
//# sourceMappingURL=coupon-variant-icon.js.map
