...
export function RewindMiniIcon({
	width = 24,
	height = 24,
	color = "currentColor",
	...props
	...
	return _jsx("svg", {
		...
		height: height,
		fill: color,
		"aria-label": "Rewind Double Arrow Left",
		"aria-labelledby": "Rewind Double Arrow Left",
		"aria-hidden": true,
		...props,
		children: _jsx("path", {
...
RewindMiniIcon.displayName = "RewindMiniIcon";
export default RewindMiniIcon;
//# sourceMappingURL=rewind-mini-icon.js.map
