...
export function RewindStartMiniIcon({
	width = 24,
	height = 24,
	color = "currentColor",
	...props
	...
	return _jsx("svg", {
		...
		height: height,
		fill: color,
		"aria-label": "Rewind Left Arrow Double Arrow",
		"aria-labelledby": "Rewind Left Arrow Double Arrow",
		"aria-hidden": true,
		...props,
		children: _jsx("path", {
...
RewindStartMiniIcon.displayName = "RewindStartMiniIcon";
export default RewindStartMiniIcon;
//# sourceMappingURL=rewind-start-mini-icon.js.map
