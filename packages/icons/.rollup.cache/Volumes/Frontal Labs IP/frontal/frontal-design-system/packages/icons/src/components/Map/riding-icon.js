...
export function RidingIcon({
	...
	return _jsx("svg", {
		...
		height: height,
		fill: color,
		"aria-label": "Bicycle Rider Cycling",
		"aria-labelledby": "Bicycle Rider Cycling",
		"aria-hidden": true,
		...props,
		children: _jsx("path", {
...
RidingIcon.displayName = "RidingIcon";
export default RidingIcon;
//# sourceMappingURL=riding-icon.js.map
