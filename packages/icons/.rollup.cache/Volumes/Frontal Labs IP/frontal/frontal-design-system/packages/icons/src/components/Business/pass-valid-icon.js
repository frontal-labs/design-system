...
export function PassValidIcon({
	...
	return _jsx("svg", {
		...
		height: height,
		fill: color,
		"aria-label": "Check Valid Pass",
		"aria-labelledby": "Check Valid Pass",
		"aria-hidden": true,
		...props,
		children: _jsx("path", {
...
PassValidIcon.displayName = "PassValidIcon";
export default PassValidIcon;
//# sourceMappingURL=pass-valid-icon.js.map
