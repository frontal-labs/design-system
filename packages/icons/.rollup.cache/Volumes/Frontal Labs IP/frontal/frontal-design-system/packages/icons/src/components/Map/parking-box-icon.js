...
export function ParkingBoxIcon({
	width = 24,
	height = 24,
	color = "currentColor",
	...props
	...
	return _jsx("svg", {
		...
		height: height,
		fill: color,
		"aria-label": "Parking Box",
		"aria-labelledby": "Parking Box",
		"aria-hidden": true,
		...props,
		children: _jsx("path", {
...
ParkingBoxIcon.displayName = "ParkingBoxIcon";
export default ParkingBoxIcon;
//# sourceMappingURL=parking-box-icon.js.map
