...
export function LoopLeftAiIcon({
	width = 24,
	height = 24,
	color = "currentColor",
	...props
	...
	return _jsx("svg", {
		...
		height: height,
		fill: color,
		"aria-label": "Loop Left Arrow",
		"aria-labelledby": "Loop Left Arrow",
		"aria-hidden": true,
		...props,
		children: _jsx("path", {
...
LoopLeftAiIcon.displayName = "LoopLeftAiIcon";
export default LoopLeftAiIcon;
//# sourceMappingURL=loop-left-ai-icon.js.map
