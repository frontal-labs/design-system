...
export function WirelessChargingIcon({
	width = 24,
	height = 24,
	color = "currentColor",
	...props
	...
	return _jsx("svg", {
		...
		height: height,
		fill: color,
		"aria-label": "Wireless Charging Battery",
		"aria-labelledby": "Wireless Charging Battery",
		"aria-hidden": true,
		...props,
		children: _jsx("path", {
...
WirelessChargingIcon.displayName = "WirelessChargingIcon";
export default WirelessChargingIcon;
//# sourceMappingURL=wireless-charging-icon.js.map
