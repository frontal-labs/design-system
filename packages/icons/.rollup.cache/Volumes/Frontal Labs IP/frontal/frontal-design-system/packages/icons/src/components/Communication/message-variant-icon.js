...
export function MessageVariantIcon({
	width = 24,
	height = 24,
	color = "currentColor",
	...props
	...
	return _jsx("svg", {
		...
		"aria-labelledby": "Message Variant",
		"aria-hidden": true,
		...props,
		children: _jsx("path", {
...
MessageVariantIcon.displayName = "MessageVariantIcon";
export default MessageVariantIcon;
//# sourceMappingURL=message-variant-icon.js.map
