...
export function PuzzleVariantIcon({
	width = 24,
	height = 24,
	color = "currentColor",
	...props
	...
	return _jsx("svg", {
		...
		height: height,
		fill: color,
		"aria-label": "Puzzle Jigsaw Piece",
		"aria-labelledby": "Puzzle Jigsaw Piece",
		"aria-hidden": true,
		...props,
		children: _jsx("path", {
...
PuzzleVariantIcon.displayName = "PuzzleVariantIcon";
export default PuzzleVariantIcon;
//# sourceMappingURL=puzzle-variant-icon.js.map
