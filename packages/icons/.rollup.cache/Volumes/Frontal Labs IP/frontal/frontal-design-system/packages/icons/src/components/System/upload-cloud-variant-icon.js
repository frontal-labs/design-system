...
export function UploadCloudVariantIcon({
	width = 24,
	height = 24,
	color = "currentColor",
	...props
	...
	return _jsx("svg", {
		...
		height: height,
		fill: color,
		"aria-label": "Cloud Upload Arrow",
		"aria-labelledby": "Cloud Upload Arrow",
		"aria-hidden": true,
		...props,
		children: _jsx("path", {
...
UploadCloudVariantIcon.displayName = "UploadCloudVariantIcon";
export default UploadCloudVariantIcon;
//# sourceMappingURL=upload-cloud-variant-icon.js.map
