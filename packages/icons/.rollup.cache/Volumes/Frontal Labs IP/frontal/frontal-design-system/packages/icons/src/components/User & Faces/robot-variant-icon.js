...
export function RobotVariantIcon({
	width = 24,
	height = 24,
	color = "currentColor",
	...props
...
RobotVariantIcon.displayName = "RobotVariantIcon";
export default RobotVariantIcon;
//# sourceMappingURL=robot-variant-icon.js.map
