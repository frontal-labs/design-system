...
export function Inbox_2Icon({ width = 24, height = 24, color = "currentColor", ...props }) {
...
Inbox_2Icon.displayName = "Inbox_2Icon";
export default Inbox_2Icon;
//# sourceMappingURL=inbox-2-icon.js.map