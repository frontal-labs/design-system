...
export function TranslateAiIcon({
	width = 24,
	height = 24,
	color = "currentColor",
	...props
	...
	return _jsx("svg", {
		...
		height: height,
		fill: color,
		"aria-label": "Translate Ai Speech Bubble",
		"aria-labelledby": "Translate Ai Speech Bubble",
		"aria-hidden": true,
		...props,
		children: _jsx("path", {
...
TranslateAiIcon.displayName = "TranslateAiIcon";
export default TranslateAiIcon;
//# sourceMappingURL=translate-ai-icon.js.map
