...
Comprehensive guide for using `@frontal-labs/colors` in your applications.
...
```tsx
import { gray, blue, semantic } from '@frontal-labs/colors';
...
import '@frontal-labs/colors/styles/styles.css';

// Import semantic color CSS variables
import '@frontal-labs/colors/styles/theme.css';
...
```tsx
import { gray, blue, green } from '@frontal-labs/colors';
...
```tsx
import { getColor, getScale } from '@frontal-labs/colors';
...
```tsx
import { getColor, type ColorScaleName, type ColorShade } from '@frontal-labs/colors';
...
```tsx
import { semantic, semanticDark } from '@frontal-labs/colors';
...
```tsx
import { getAllScales, type ColorScaleName } from '@frontal-labs/colors';
...
import { gray, semantic } from '@frontal-labs/colors';
...
import { blue, semantic } from '@frontal-labs/colors';
...
```tsx
import { getColor } from '@frontal-labs/colors';
...
```tsx
import { getColor, type ColorScaleName } from '@frontal-labs/colors';
...
```tsx
import { getAllScales } from '@frontal-labs/colors';
...
- Ensure CSS files are imported: `import '@frontal-labs/colors/styles/styles.css'`
...
- Import types explicitly: `import type { ColorScaleName } from '@frontal-labs/colors'`
