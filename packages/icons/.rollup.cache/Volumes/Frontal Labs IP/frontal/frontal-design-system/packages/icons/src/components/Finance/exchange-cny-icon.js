...
export function ExchangeCnyIcon({
	width = 24,
	height = 24,
	color = "currentColor",
	...props
	...
	return _jsx("svg", {
		...
		height: height,
		fill: color,
		"aria-label": "Exchange Currency Cny",
		"aria-labelledby": "Exchange Currency Cny",
		"aria-hidden": true,
		...props,
		children: _jsx("path", {
...
ExchangeCnyIcon.displayName = "ExchangeCnyIcon";
export default ExchangeCnyIcon;
//# sourceMappingURL=exchange-cny-icon.js.map
