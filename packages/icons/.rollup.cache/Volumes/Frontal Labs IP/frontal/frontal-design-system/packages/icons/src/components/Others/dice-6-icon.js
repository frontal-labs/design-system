...
export function Dice_6Icon({
	...
	return _jsx("svg", {
		...
		height: height,
		fill: color,
		"aria-label": "Dice Dice 6 Board Game",
		"aria-labelledby": "Dice Dice 6 Board Game",
		"aria-hidden": true,
		...props,
		children: _jsx("path", {
...
Dice_6Icon.displayName = "Dice_6Icon";
export default Dice_6Icon;
//# sourceMappingURL=dice-6-icon.js.map
