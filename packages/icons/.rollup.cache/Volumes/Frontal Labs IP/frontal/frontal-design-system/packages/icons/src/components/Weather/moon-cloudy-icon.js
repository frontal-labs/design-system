...
export function MoonCloudyIcon({
	width = 24,
	height = 24,
	color = "currentColor",
	...props
	...
	return _jsx("svg", {
		...
		height: height,
		fill: color,
		"aria-label": "Moon Cloud Cloudy",
		"aria-labelledby": "Moon Cloud Cloudy",
		"aria-hidden": true,
		...props,
		children: _jsx("path", {
...
MoonCloudyIcon.displayName = "MoonCloudyIcon";
export default MoonCloudyIcon;
//# sourceMappingURL=moon-cloudy-icon.js.map
