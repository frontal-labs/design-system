...
export function AiGenerateIcon({
	...
	return _jsx("svg", {
		...
		height: height,
		fill: color,
		"aria-label": "Magic Sparkle Generate",
		"aria-labelledby": "Magic Sparkle Generate",
		"aria-hidden": true,
		...props,
		children: _jsx("path", {
...
AiGenerateIcon.displayName = "AiGenerateIcon";
export default AiGenerateIcon;
//# sourceMappingURL=ai-generate-icon.js.map
