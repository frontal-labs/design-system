...
export function DoubleQuotesLIcon({
	width = 24,
	height = 24,
	color = "currentColor",
	...props
	...
	return _jsx("svg", {
		...
		height: height,
		fill: color,
		"aria-label": "Double Quote Quotes Quotation Mark",
		"aria-labelledby": "Double Quote Quotes Quotation Mark",
		"aria-hidden": true,
		...props,
		children: _jsx("path", {
...
DoubleQuotesLIcon.displayName = "DoubleQuotesLIcon";
export default DoubleQuotesLIcon;
//# sourceMappingURL=double-quotes-l-icon.js.map
