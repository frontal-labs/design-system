...
export function MapPinUserIcon({
	width = 24,
	height = 24,
	color = "currentColor",
	...props
	...
	return _jsx("svg", {
		...
		height: height,
		fill: color,
		"aria-label": "Map Pin User Location",
		"aria-labelledby": "Map Pin User Location",
		"aria-hidden": true,
		...props,
		children: _jsx("path", {
...
MapPinUserIcon.displayName = "MapPinUserIcon";
export default MapPinUserIcon;
//# sourceMappingURL=map-pin-user-icon.js.map
