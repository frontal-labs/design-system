...
export function ChatAiVariantIcon({
	width = 24,
	height = 24,
	color = "currentColor",
	...props
	...
	return _jsx("svg", {
		...
		height: height,
		fill: color,
		"aria-label": "Chat Ai Variant",
		"aria-labelledby": "Chat Ai Variant",
		"aria-hidden": true,
		...props,
		children: _jsx("path", {
...
ChatAiVariantIcon.displayName = "ChatAiVariantIcon";
export default ChatAiVariantIcon;
//# sourceMappingURL=chat-ai-variant-icon.js.map
