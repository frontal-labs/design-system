...
export function EmphasisCnIcon({
	width = 24,
	height = 24,
	color = "currentColor",
	...props
	...
	return _jsx("svg", {
		...
		height: height,
		fill: color,
		"aria-label": "Highlight Pen Text",
		"aria-labelledby": "Highlight Pen Text",
		"aria-hidden": true,
		...props,
		children: _jsx("path", {
...
EmphasisCnIcon.displayName = "EmphasisCnIcon";
export default EmphasisCnIcon;
//# sourceMappingURL=emphasis-cn-icon.js.map
