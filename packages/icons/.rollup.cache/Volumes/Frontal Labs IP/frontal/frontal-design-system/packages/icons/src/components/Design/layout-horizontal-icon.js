...
export function LayoutHorizontalIcon({
	...
	return _jsx("svg", {
		...
		height: height,
		fill: color,
		"aria-label": "Layout Horizontal Grid",
		"aria-labelledby": "Layout Horizontal Grid",
		"aria-hidden": true,
		...props,
		children: _jsx("path", {
...
LayoutHorizontalIcon.displayName = "LayoutHorizontalIcon";
export default LayoutHorizontalIcon;
//# sourceMappingURL=layout-horizontal-icon.js.map
