...
export function PencilAiVariantIcon({
	width = 24,
	height = 24,
	color = "currentColor",
	...props
	...
	return _jsx("svg", {
		...
		height: height,
		fill: color,
		"aria-label": "Pencil Write Edit",
		"aria-labelledby": "Pencil Write Edit",
		"aria-hidden": true,
		...props,
		children: _jsx("path", {
...
PencilAiVariantIcon.displayName = "PencilAiVariantIcon";
export default PencilAiVariantIcon;
//# sourceMappingURL=pencil-ai-variant-icon.js.map
