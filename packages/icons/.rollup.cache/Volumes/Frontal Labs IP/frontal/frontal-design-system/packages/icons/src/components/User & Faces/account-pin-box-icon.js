...
export function AccountPinBoxIcon({
	width = 24,
	height = 24,
	color = "currentColor",
	...props
	...
	return _jsx("svg", {
		...
		height: height,
		fill: color,
		"aria-label": "Account Pin Box",
		"aria-labelledby": "Account Pin Box",
		"aria-hidden": true,
		...props,
		children: _jsx("path", {
...
AccountPinBoxIcon.displayName = "AccountPinBoxIcon";
export default AccountPinBoxIcon;
//# sourceMappingURL=account-pin-box-icon.js.map
