...
export function MoneyDollarBoxIcon({
	width = 24,
	height = 24,
	color = "currentColor",
	...props
	...
	return _jsx("svg", {
		...
		height: height,
		fill: color,
		"aria-label": "Money Dollar Box",
		"aria-labelledby": "Money Dollar Box",
		"aria-hidden": true,
		...props,
		children: _jsx("path", {
...
MoneyDollarBoxIcon.displayName = "MoneyDollarBoxIcon";
export default MoneyDollarBoxIcon;
//# sourceMappingURL=money-dollar-box-icon.js.map
