...
export function MapPinTimeIcon({
	width = 24,
	height = 24,
	color = "currentColor",
	...props
	...
	return _jsx("svg", {
		...
		height: height,
		fill: color,
		"aria-label": "Map Pin Location Clock",
		"aria-labelledby": "Map Pin Location Clock",
		"aria-hidden": true,
		...props,
		children: _jsx("path", {
...
MapPinTimeIcon.displayName = "MapPinTimeIcon";
export default MapPinTimeIcon;
//# sourceMappingURL=map-pin-time-icon.js.map
