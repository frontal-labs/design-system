...
export function AccountPinCircleIcon({
	width = 24,
	height = 24,
	color = "currentColor",
	...props
	...
	return _jsx("svg", {
		...
		height: height,
		fill: color,
		"aria-label": "Account Pin Circle",
		"aria-labelledby": "Account Pin Circle",
		"aria-hidden": true,
		...props,
		children: _jsx("path", {
...
AccountPinCircleIcon.displayName = "AccountPinCircleIcon";
export default AccountPinCircleIcon;
//# sourceMappingURL=account-pin-circle-icon.js.map
