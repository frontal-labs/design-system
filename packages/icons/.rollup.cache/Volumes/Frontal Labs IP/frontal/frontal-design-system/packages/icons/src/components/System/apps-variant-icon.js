...
export function AppsVariantIcon({
	width = 24,
	height = 24,
	color = "currentColor",
	...props
	...
	return _jsx("svg", {
		...
		height: height,
		fill: color,
		"aria-label": "Apps Variant",
		"aria-labelledby": "Apps Variant",
		"aria-hidden": true,
		...props,
		children: _jsx("path", {
...
AppsVariantIcon.displayName = "AppsVariantIcon";
export default AppsVariantIcon;
//# sourceMappingURL=apps-variant-icon.js.map
