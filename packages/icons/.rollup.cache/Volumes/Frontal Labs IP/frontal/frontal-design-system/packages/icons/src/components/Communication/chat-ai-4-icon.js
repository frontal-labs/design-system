...
export function ChatAi_4Icon({
	...
	return _jsx("svg", {
		...
		height: height,
		fill: color,
		"aria-label": "Chat Bubble Message",
		"aria-labelledby": "Chat Bubble Message",
		"aria-hidden": true,
		...props,
		children: _jsx("path", {
...
ChatAi_4Icon.displayName = "ChatAi_4Icon";
export default ChatAi_4Icon;
//# sourceMappingURL=chat-ai-4-icon.js.map
