...
export function DownloadCloudVariantIcon({
	width = 24,
	height = 24,
	color = "currentColor",
	...props
	...
	return _jsx("svg", {
		...
		height: height,
		fill: color,
		"aria-label": "Download Cloud Variant",
		"aria-labelledby": "Download Cloud Variant",
		"aria-hidden": true,
		...props,
		children: _jsx("path", {
...
DownloadCloudVariantIcon.displayName = "DownloadCloudVariantIcon";
export default DownloadCloudVariantIcon;
//# sourceMappingURL=download-cloud-variant-icon.js.map
