...
export function ImageAiIcon({
	...
	return _jsx("svg", {
		...
		height: height,
		fill: color,
		"aria-label": "Camera Image Photo",
		"aria-labelledby": "Camera Image Photo",
		"aria-hidden": true,
		...props,
		children: _jsx("path", {
...
ImageAiIcon.displayName = "ImageAiIcon";
export default ImageAiIcon;
//# sourceMappingURL=image-ai-icon.js.map
