...
export function LightbulbFlashIcon({
	width = 24,
	height = 24,
	color = "currentColor",
	...props
	...
	return _jsx("svg", {
		...
		height: height,
		fill: color,
		"aria-label": "Lightbulb Flash Idea",
		"aria-labelledby": "Lightbulb Flash Idea",
		"aria-hidden": true,
		...props,
		children: _jsx("path", {
...
LightbulbFlashIcon.displayName = "LightbulbFlashIcon";
export default LightbulbFlashIcon;
//# sourceMappingURL=lightbulb-flash-icon.js.map
