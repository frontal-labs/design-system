...
export function FileAiVariantIcon({
	width = 24,
	height = 24,
	color = "currentColor",
	...props
	...
	return _jsx("svg", {
		...
		height: height,
		fill: color,
		"aria-label": "File Document Ai",
		"aria-labelledby": "File Document Ai",
		"aria-hidden": true,
		...props,
		children: _jsx("path", {
...
FileAiVariantIcon.displayName = "FileAiVariantIcon";
export default FileAiVariantIcon;
//# sourceMappingURL=file-ai-variant-icon.js.map
