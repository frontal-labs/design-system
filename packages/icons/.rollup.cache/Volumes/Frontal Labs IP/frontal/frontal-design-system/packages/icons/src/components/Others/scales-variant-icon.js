...
export function ScalesVariantIcon({
	width = 24,
	height = 24,
	color = "currentColor",
	...props
	...
	return _jsx("svg", {
		...
		height: height,
		fill: color,
		"aria-label": "Balance Scales Justice",
		"aria-labelledby": "Balance Scales Justice",
		"aria-hidden": true,
		...props,
		children: _jsx("path", {
...
ScalesVariantIcon.displayName = "ScalesVariantIcon";
export default ScalesVariantIcon;
//# sourceMappingURL=scales-variant-icon.js.map
