...
export function ChatAi_2Icon({
	...
	return _jsx("svg", {
		...
		height: height,
		fill: color,
		"aria-label": "Chat Ai_2",
		"aria-labelledby": "Chat Ai_2",
		"aria-hidden": true,
		...props,
		children: _jsx("path", {
...
ChatAi_2Icon.displayName = "ChatAi_2Icon";
export default ChatAi_2Icon;
//# sourceMappingURL=chat-ai-2-icon.js.map
