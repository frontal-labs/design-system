...
export function ChatSettingsIcon({
	width = 24,
	height = 24,
	color = "currentColor",
	...props
	...
	return _jsx("svg", {
		...
		height: height,
		fill: color,
		"aria-label": "Chat Settings Gear",
		"aria-labelledby": "Chat Settings Gear",
		"aria-hidden": true,
		...props,
		children: _jsx("path", {
...
ChatSettingsIcon.displayName = "ChatSettingsIcon";
export default ChatSettingsIcon;
//# sourceMappingURL=chat-settings-icon.js.map
