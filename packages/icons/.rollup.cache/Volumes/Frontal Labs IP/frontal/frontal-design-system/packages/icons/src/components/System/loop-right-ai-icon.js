...
export function LoopRightAiIcon({
	width = 24,
	height = 24,
	color = "currentColor",
	...props
...
LoopRightAiIcon.displayName = "LoopRightAiIcon";
export default LoopRightAiIcon;
//# sourceMappingURL=loop-right-ai-icon.js.map
