...
export function MoneyCnyCircleIcon({
	width = 24,
	height = 24,
	color = "currentColor",
	...props
	...
	return _jsx("svg", {
		...
		height: height,
		fill: color,
		"aria-label": "Money Cny Circle",
		"aria-labelledby": "Money Cny Circle",
		"aria-hidden": true,
		...props,
		children: _jsx("path", {
...
MoneyCnyCircleIcon.displayName = "MoneyCnyCircleIcon";
export default MoneyCnyCircleIcon;
//# sourceMappingURL=money-cny-circle-icon.js.map
