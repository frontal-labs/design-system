...
export function AncientPavilionIcon({
	width = 24,
	height = 24,
	color = "currentColor",
	...props
	...
	return _jsx("svg", {
		...
		height: height,
		fill: color,
		"aria-label": "Ancient Pavilion Building",
		"aria-labelledby": "Ancient Pavilion Building",
		"aria-hidden": true,
		...props,
		children: _jsx("path", {
...
AncientPavilionIcon.displayName = "AncientPavilionIcon";
export default AncientPavilionIcon;
//# sourceMappingURL=ancient-pavilion-icon.js.map
