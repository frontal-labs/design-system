...
export function LandscapeAiIcon({
	width = 24,
	height = 24,
	color = "currentColor",
	...props
	...
	return _jsx("svg", {
		...
		height: height,
		fill: color,
		"aria-label": "Landscape Ai",
		"aria-labelledby": "Landscape Ai",
		"aria-hidden": true,
		...props,
		children: _jsx("path", {
...
LandscapeAiIcon.displayName = "LandscapeAiIcon";
export default LandscapeAiIcon;
//# sourceMappingURL=landscape-ai-icon.js.map
