...
export function RestaurantVariantIcon({
	width = 24,
	height = 24,
	color = "currentColor",
	...props
	...
	return _jsx("svg", {
		...
		height: height,
		fill: color,
		"aria-label": "Restaurant Food Fork",
		"aria-labelledby": "Restaurant Food Fork",
		"aria-hidden": true,
		...props,
		children: _jsx("path", {
...
RestaurantVariantIcon.displayName = "RestaurantVariantIcon";
export default RestaurantVariantIcon;
//# sourceMappingURL=restaurant-variant-icon.js.map
