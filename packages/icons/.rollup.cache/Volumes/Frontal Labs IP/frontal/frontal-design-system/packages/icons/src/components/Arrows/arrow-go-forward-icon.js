...
export function ArrowGoForwardIcon({
	width = 24,
	height = 24,
	color = "currentColor",
	...props
	...
	return _jsx("svg", {
		...
		height: height,
		fill: color,
		"aria-label": "Arrow Forward Navigation",
		"aria-labelledby": "Arrow Forward Navigation",
		"aria-hidden": true,
		...props,
		children: _jsx("path", {
...
ArrowGoForwardIcon.displayName = "ArrowGoForwardIcon";
export default ArrowGoForwardIcon;
//# sourceMappingURL=arrow-go-forward-icon.js.map
