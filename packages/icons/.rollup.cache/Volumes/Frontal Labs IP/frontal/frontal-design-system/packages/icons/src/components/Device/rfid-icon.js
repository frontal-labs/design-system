...
export function RfidIcon({
	...
	return _jsx("svg", {
		...
		height: height,
		fill: color,
		"aria-label": "Rfid Wireless Signal",
		"aria-labelledby": "Rfid Wireless Signal",
		"aria-hidden": true,
		...props,
		children: _jsx("path", {
...
RfidIcon.displayName = "RfidIcon";
export default RfidIcon;
//# sourceMappingURL=rfid-icon.js.map
