...
type GroupTextProps = useRender.ComponentProps<"div">;

function GroupText({ className, render, ...props }: GroupTextProps) {
	const defaultProps = {
		className: cn(
...
type GroupSeparatorProps = ComponentProps<typeof Separator>;
