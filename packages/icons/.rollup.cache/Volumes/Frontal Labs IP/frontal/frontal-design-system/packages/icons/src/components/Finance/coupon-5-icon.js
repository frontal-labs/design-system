...
export function Coupon_5Icon({
	...
	return _jsx("svg", {
		...
		height: height,
		fill: color,
		"aria-label": "Coupon Voucher Discount",
		"aria-labelledby": "Coupon Voucher Discount",
		"aria-hidden": true,
		...props,
		children: _jsx("path", {
...
Coupon_5Icon.displayName = "Coupon_5Icon";
export default Coupon_5Icon;
//# sourceMappingURL=coupon-5-icon.js.map
