...
export function ChinaRailwayIcon({
	width = 24,
	height = 24,
	color = "currentColor",
	...props
	...
	return _jsx("svg", {
		...
		height: height,
		fill: color,
		"aria-label": "Train Railway Transport",
		"aria-labelledby": "Train Railway Transport",
		"aria-hidden": true,
		...props,
		children: _jsx("path", {
...
ChinaRailwayIcon.displayName = "ChinaRailwayIcon";
export default ChinaRailwayIcon;
//# sourceMappingURL=china-railway-icon.js.map
